...
public interface AgentExecutor {
    ...
    record Command(
        ...
        public Command(
                ...
                String input, Duration timeout, String traceId, long runId,
                String processInstanceId, String nodeToolSetJson, String checkpointStateJson,
                BiConsumer<Integer, StepProgress> progressListener) {
            this(tenantCode, version, provider, input, timeout, traceId, runId, processInstanceId,
                    nodeToolSetJson, checkpointStateJson, progressListener, null);
        }
        ...
        public Command(String tenantCode, AgentDefinitionVersion version, AgentProvider provider,
            ...
            this(tenantCode, version, provider, input, timeout, traceId, 0, null, null, null, null, null);
        }

        public Command(
                String tenantCode, AgentDefinitionVersion version, AgentProvider provider,
                String input, Duration timeout, String traceId, String processInstanceId) {
            this(tenantCode, version, provider, input, timeout, traceId, 0, processInstanceId, null, null, null, null);
        }
        ...
        public Command(
            ...
            this(tenantCode, version, provider, input, timeout, traceId, 0, processInstanceId,
                    nodeToolSetJson, null, null, null);
        }
    }
